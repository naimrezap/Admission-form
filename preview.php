  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="https://media-exp1.licdn.com/dms/image/C510BAQGv9RST03zZMw/company-logo_200_200/0/1547573193824?e=2159024400&v=beta&t=IevOwfW-FjMRs9DnVWwPfrGoIp5S1pO5s_Q1pov2nlE">
          </div>
           <div class="col">
              <div class="main-heading"><h1>Pabna University of Sciece and technology </h1></div>
     <p class="sub-heading" align="center">  Email: pust@2008.com. Address: Rajapur,Pabna.</p>
      <div class="address"> 
</div>
         <p class="email"> </p>
          </div>
